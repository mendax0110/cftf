...
/// @brief The main namespace for the Clang-based Template Specializer tool \namespace cftf
namespace cftf
{
    /**
     * The SourceRangeLength function calculates the length of a SourceRange in characters.
     * 
     * \param sm -> The SourceManager object
     * \param range -> The Range to the Source
     * \return -> auto -> The length of the SourceRange in characters
     */
    ...
    /**
     * The SourceRangeToString function converts a SourceRange to a string.
     * 
     * \param sm -> The SourceManager object
     * \param range -> The Range to the Source
     * \return -> auto -> The string representation of the SourceRange
     */
    ...
    /**
     * The IsSubRange function checks if one SourceRange is a sub-range of another.
     * 
     * \param sm -> The SourceManager object
     * \param inner -> The inner SourceRange
     * \param outer -> The outer SourceRange
     * \return -> bool -> True if the inner SourceRange is a sub-range of the outer SourceRange
     */
    ...
    {
        /**
         * The SourceNode struct represents a node in the hierarchical rewriter.
         */
        struct SourceNode
        {
            ...
            /**
             * The IsLeaf function checks if the SourceNode is a leaf node.
             * 
             * \return -> bool -> True if the SourceNode is a leaf node
             */
            bool IsLeaf() const
            {
            ...
            /**
             * GetChildren function returns the children of the SourceNode.
             * 
             * \return -> std::vector<SourceNode>& -> The children of the SourceNode
             */
             ...
             * GetChildren function returns the children of the SourceNode.
             * 
             * \return -> const std::vector<SourceNode>& -> The children of the SourceNode
             */
            ...
            /**
             * The GetContent function gets the content of the SourceNode.
             * 
             * \return -> std::string& -> The content of the SourceNode
             */
            ...
            /**
             * The Concatenate function concatenates the content of the SourceNode.
             * 
             * \return -> std::string -> The concatenated content of the SourceNode
             */
            std::string Concatenate() const
            {
                ...
                {
                    return std::accumulate(GetChildren().cbegin(), GetChildren().cend(), std::string{}, [](const std::string& str, const SourceNode& node) { return str + node.Concatenate(); });
                }
            }
            ...
            /**
             * The operator== function checks if two SourceNodes are equal.
             * 
             * \param oth -> The other SourceNode
             * \return -> bool -> True if the SourceNodes are equal
             */
    ...
    public:
        /**
         * The InstanceHandle struct represents a handle to an instance of a SourceNode.
         */
        ...
        /**
         * The Ctor of the HierarchicalRewriter class.
         * 
         * \param sm -> The SourceManager object
         * \param range -> The Range to the Source
         */
        ...
        /**
         * The GetContents function gets the contents of the HierarchicalRewriter.
         * 
         * \return -> std::string -> The contents of the HierarchicalRewriter
         */
        ...
        /**
         * The MakeInstanceHandle function creates an InstanceHandle for a subrange.
         * 
         * \param subrange -> The Range to the Source
         * \return -> InstanceHandle -> The InstanceHandle for the subrange
         */
        ...
        /**
         * The FindNode function finds a SourceNode by its id.
         * 
         * \param parent -> The parent SourceNode
         * \param id-> The id of the SourceNode
         * \return -> SourceNode& -> The SourceNode
         */
        ...
        /**
         * The CreateNewInstance function creates a new instance of a SourceNode.
         * 
         * \param base_instance -> The base InstanceHandle
         * \return -> InstanceHandle -> The new InstanceHandle
         */
        ...
        /**
         * The ReplaceTextIncludingEndToken function replaces text in a SourceRange.
         * 
         * \param instance -> The InstanceHandle
         * \param replaced_range -> The Range to the Source
         * \param new_str -> The new string
         * \return -> bool -> True if the text was replaced
         */
    ...
    private:
        /**
         * The FindNodeHelper function finds a SourceNode by its id.
         * 
         * \param parent -> The parent SourceNode
         * \param id -> The id of the SourceNode
         * \return -> SourceNode* -> The SourceNode
        ...
        /**
         *  The SplitNodeAt function splits a SourceNode at a subrange.
         * 
         * \param node -> The SourceNode
         * \param subrange -> The Range to the Source
         * \return -> SourceNode& -> The SourceNode
         */
    ...
    public:
        ...
        bool ReplaceTextExcludingEndToken(SourceNode& node, clang::SourceRange replaced_range, llvm::StringRef new_str)
        {
            if (node.IsLeaf())
            {
                ...
                else
                {
                    ...
                    inner_node.data = std::string(new_str);
                }
            }
            else
            {
                ...
                auto child_it = std::find_if(children.begin(), children.end(), [&](SourceNode& child) { return IsSubRange(sm, replaced_range, child.range); });
                ...
                if (child_it == children.end())
                {
                    ...
                    auto child_is_fully_covered = [&](SourceNode& child) { bool fully_covered = IsSubRange(sm, child.range, replaced_range); return fully_covered; };
                    ...
                    if (!new_str.empty())
                    {
                        ...
                        *first_child = SourceNode { { first_child->range.getBegin(), range_end }, false, static_cast<std::string>(new_str), ++running_node_id};
                    }
        ...
        InstanceHandle MakeInstanceHandle(SourceNode& parent, clang::SourceRange subrange)
        {
            ...
            {
                auto& children = parent.GetChildren();
                auto child_it = std::find_if(children.begin(), children.end(), [&](SourceNode& child) { return IsSubRange(sm, subrange, child.range); });
    ...
    public:
        ...
        bool VisitStmt(clang::Stmt* stmt)
        {
            ...
            auto is_generated_stmt = [this](clang::Stmt* candidate) { auto expected_stmt_class = expr->getStmtClass();
    ...
    clang::ParmVarDecl* ASTVisitor::CurrentFunctionInfo::FindTemplatedParamDecl(clang::ParmVarDecl* specialized) const
    {
        auto it = std::find_if(parameters.begin(), parameters.end(), 
            [specialized](const Parameter& param) { auto it = std::find_if(param.specialized.begin(), param.specialized.end(),
            [=](const Parameter::SpecializedParameter& parameter) { return (parameter.decl == specialized); }); return (it != param.specialized.end()); });
    ...
    {
        auto it = std::find_if(parameters.begin(), parameters.end(), [templated](const Parameter& param) { return (param.templated == templated); });
    ...
    bool ASTVisitor::VisitSizeOfPackExpr(clang::SizeOfPackExpr* expr)
    {
        ...
        rewriter->ReplaceTextIncludingEndToken({ expr->getBeginLoc(), expr->getEndLoc() }, "/*" + GetClosedStringFor(expr->getBeginLoc(), expr->getEndLoc()) + "*/" + std::to_string(expr->getPackLength()));
        return true;
    }
    ...
    {
        if (context.getFullLoc(decl->getBeginLoc()).isInSystemHeader())
        {
        ...
        for (auto* specialized_decl : decl->specializations())
        {
            ...
            if (specialize)
            {
                ...
                old_rewriter = std::exchange(rewriter, std::make_unique<HierarchicalRewriter>(rewriter->getSourceMgr(), clang::SourceRange{ specialized_decl->getBeginLoc(), getLocForEndOfToken(specialized_decl->getEndLoc()) }));
                    ...
                    for (auto it = template_args.begin(); it != template_args.end(); ++it)
                    {
                        ...
                        if (it->getKind() == clang::TemplateArgument::Pack)
                        {
                            ...
                            for (auto pack_it = it->pack_begin(); pack_it < it->pack_end(); ++pack_it)
                            {
                                ...
                                pack_it->print(policy, ss, true);
                            }
                        }
                        else
                        {
                            it->print(policy, ss, true);
                        }
                    }
                    ss.flush();
                ...
                std::transform(templated_decl->param_begin(), templated_decl->param_end(), std::back_inserter(current_function.parameters), [&](clang::ParmVarDecl* templated_param_decl)
                {
                ...
                for (auto templated_parameter_it = templated_decl->param_begin(); templated_parameter_it != templated_decl->param_end(); ++templated_parameter_it)
                {
                    ...
                    if (templated_parameter->isParameterPack() && current_function.FindSpecializedParamDecls(templated_parameter).empty())
                    {
                        ...
                        clang::SourceLocation start_loc = is_first_parameter ? templated_decl->parameters().front()->getBeginLoc() : templated_parameter->getBeginLoc();
                        if (is_last_parameter)
                        {
                            // Delete up to the end of the function signature
                            clang::SourceLocation end_loc = templated_decl->parameters().back()->getEndLoc();
                            rewriter->ReplaceTextIncludingEndToken({start_loc, end_loc}, "");
                        }
                        else
                        {
                            // Delete up to the beginning of the next parameter
                            auto end_loc = (*std::next(templated_parameter_it))->getBeginLoc();
            ...
            /*if (decl2->getPrimaryTemplate())*/ {
                ...
                if (current_function_template_it != function_templates.end())
                {
                    ...
                    for (auto [pack_expansion_expr, pack_uses] : current_function_template->param_pack_expansions)
                    {
                        ...
                        auto base_instance = rewriter->MakeInstanceHandle({pattern->getBeginLoc(), range_end});
                        ...
                        rewriter->ReplaceTextExcludingEndToken(base_instance, {pattern->getBeginLoc(), range_end}, "/*" + GetClosedStringFor(pattern->getBeginLoc(), range_end) + " of size " + std::to_string(pack_length) + "*/");
                        ...
                        for (size_t instance_id = 0; instance_id < pack_length; ++instance_id)
                        {
                            ...
                            {
                                clang::SourceRange range = { pack_expr->getBeginLoc(), clang::Lexer::getLocForEndOfToken(pack_expr->getEndLoc(), 0, rewriter->getSourceMgr(), {}) };
            ...
            if (specialize)
            {
                ...
                for (; parameter_it != template_parameters->end(); ++parameter_it, ++argument_it)
                {
                    ...
                    case clang::TemplateArgument::Integral:
                       ...
                       // aliases += "auto " + parameter->getNameAsString() + " = " + argument.getAsIntegral(). + ";\n";
                        break;
                ...
                rewriter->InsertTextAfter(specialized_decl->getBody()->getBeginLoc(), aliases);
                ...
                rewriter->InsertTextAfter(specialized_decl->getEndLoc(), "\n\n// Specialization generated by CFTF\n" + deduced_return_type + "\ntemplate<>\n" + content);
            }
        }
        ...
        if (deduce_return_type) 
        {
            ...
            // NOTE: templated_decl->getBeginLoc() starts *after* the
            //       template<typename> part, so we indeed need decl->getBeginLoc()
            //       here instead
            rewriter->ReplaceTextExcludingEndToken({decl->getBeginLoc(), decl->getBeginLoc()}, deduced_return_type_decl);
    ...
    static std::string RebuildVarDecl(clang::SourceManager& sm, clang::VarDecl* decl)
    {
        ...
        {
            new_decl += " = " + SourceRangeToString(sm, { init->getBeginLoc(), clang::Lexer::getLocForEndOfToken(init->getEndLoc(), 0, sm, {})});
        }
        return new_decl;
    }
    ...
    bool ASTVisitor::VisitDeclStmt(clang::DeclStmt* stmt)
    {
        ...
        for (auto decl : ranges::reversed(stmt->decls()))
        {
            if (auto var_decl = clang::dyn_cast<clang::VarDecl>(decl))
            {
                ...
                rewriter->InsertTextAfter(clang::Lexer::getLocForEndOfToken(stmt->getEndLoc(), 0, rewriter->getSourceMgr(), {}), new_decl);
            }
    ...
    clang::Decl* ASTVisitor::FunctionTemplateInfo::FindTemplatedDecl(clang::SourceManager& sm, clang::Decl* specialized) const
    {
        auto is_templated_decl = [&sm,specialized](clang::Decl* candidate) {
            ...
            return  candidate->getKind() == specialized->getKind() &&
                    sm.isPointWithin(specialized->getBeginLoc(), candidate->getBeginLoc(), candidate->getEndLoc()) &&
                    sm.isPointWithin(specialized->getEndLoc(), candidate->getBeginLoc(), candidate->getEndLoc());
        };
    ...
    bool ASTVisitor::VisitVarDecl(clang::VarDecl* decl)
    {
        ...
        if (auto pv_decl = clang::dyn_cast<clang::ParmVarDecl>(decl))
        {
            ...
            if (templated->isParameterPack())
            {
                ...
                // NOTE: decl->getEndLoc() and templated->getEndLoc() return
                ...
                //       such as "T...", decl->getEndLoc() stops before the
                //       ellipsis, whereas templated->getEndLoc() includes it
                rewriter->ReplaceTextIncludingEndToken(templated->getSourceRange(), "/*Expansion of " + GetClosedStringFor(decl->getBeginLoc(), templated->getEndLoc()) + "{-*/" + addendum + "/*-}*/");
            }
            else
            {
                auto old_decl = GetClosedStringFor(decl->getBeginLoc(), decl->getEndLoc());
